...
class VGD_Network(nn.Module):
    ...
    def forward(self, input1, input2, input3):
        ...
        exemplar_pre = F.interpolate(exemplar_pre, size=input_size, mode='bilinear', align_corners=False)
        query_pre = F.interpolate(query_pre, size=input_size, mode='bilinear', align_corners=False)
        other_pre = F.interpolate(other_pre, size=input_size, mode='bilinear', align_corners=False)
