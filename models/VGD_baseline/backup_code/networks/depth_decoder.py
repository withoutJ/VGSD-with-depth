...
from networks.model_parts import ASPP
from networks.monodepth_layers import ConvBlock, Conv3x3, upsample


class DepthDecoder(nn.Module):
    first_iter = True

    def __init__(self, num_ch_enc, scales, max_scale_size=(416, 416), num_output_channels=1, use_skips=True,
